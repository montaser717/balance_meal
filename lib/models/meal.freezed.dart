...
abstract class $MealCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int calories, DateTime date});
}
...
class _$MealImpl implements _Meal {
  ...
  @override
  String toString() {
    return 'Meal(id: $id, name: $name, calories: $calories, date: $date)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, calories, date);
